...
public class Proyeccion_Esfera implements ExtendedPlugInFilter, DialogListener {
  ...
  private ImageProcessor otherSlice;  //Image data of the other slice
	...
	//private ImageStack stack_proyeccion;
	...
	//	byte[] pixels;  //arreglo para guardar slices del stack
    	...
    	//IJ.showMessage("asdsad   " + threshold);
    	
    	//IJ.showMessage("El min del otsu threshold es   " + factor_otsu);
    ...
    public void run (ImageProcessor ip) {
    	...
    	// ImagePlus image = IJ.openVirtual(direc + imagedir);
    	...
    	if(preview)
    	{
	    	...
	    	for(int h=1; h <= zs ; h++)
			{
	    		...
	    		//pixel_aux = (byte[]) stackprev.getPixels(1);
